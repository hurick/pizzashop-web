...
test('display orders correctly', async ({ page }) => {
...
test('display next page correctly', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
...
test('display previous page correctly', async ({ page }) => {
...
test('display last page correctly', async ({ page }) => {
  await page.goto('/orders', { waitUntil: 'networkidle' })
...
test('display first page correctly', async ({ page }) => {
  await page.goto('/orders?page=10', { waitUntil: 'networkidle' })
